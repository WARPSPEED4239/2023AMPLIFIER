  ...
  public AutonomousCommand(Constants.TargetTask targetTask, Arm arm, Drivetrain drivetrain, IntakeClaw intakeClaw, Shifter shifter, Slider slider) {
    ...
    switch (mTargetTask) {
      ...
      case ScoreConeDriveBackwards:
        addCommands(
          new ArmSetPosition(mArm, 13.0).withTimeout(2.0), // Arm moves up for 2 seconds
      ...
      case DriveForwardAutoBalance:
        addCommands(
          new DrivetrainNoSensors(mDrivetrain, 0.7, 0.15).withTimeout(1.5),
          new AutoBalanceV2(mDrivetrain, mShifter).withTimeout(5.0));
        break;
      }
    }
  }