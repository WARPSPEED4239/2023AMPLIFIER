...
public class UnitConversion {   
    public static double inchesToSRXUnits(double inches) {
        return inches / (Constants.SPROCKET_CIRCUM / Constants.SLIDER_GEARBOX_RATIO) * Constants.SRX_UNITS_PER_ROTATION;
    }

    public static double SRXUnitsToInches(double units) {
        return (units / Constants.SRX_UNITS_PER_ROTATION) * (Constants.SPROCKET_CIRCUM / Constants.SLIDER_GEARBOX_RATIO);
    }

    public static double positionInDegreesToSRXUnits(double positionInDegrees) {
        return positionInDegrees / 360 * Constants.ARM_RATIO * Constants.SRX_UNITS_PER_ROTATION;
    }

    public static double SRXUnitsToDegrees(double units) {
        return units / Constants.SRX_UNITS_PER_ROTATION / Constants.ARM_RATIO * 360;
    }
